...
smtp_port = 587
sender_email = "eldiiarbekzhan@gmail.com"  # Replace with your email address
sender_password = "Bekosaiema..12"     # Replace with your email password or app-specific password
receiver_email = "eldiiarbekzhan@gmail.com"  # Replace with the recipient's email
